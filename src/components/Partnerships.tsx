...
const partners = [
    { name: "TechOps ID", category: "Technology Partner", desc: "Providing cloud infrastructure for Phoenix lab environments." },
    { name: "HackersHub", category: "Community Partner", desc: "Collaborating on CTF events and knowledge sharing." },
    { name: "Lampung Cyber", category: "Educational Partner", desc: "Supporting local cyber talent development." },
];
            ...
            <div className="max-w-7xl mx-auto relative z-10 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {partners.map((p, i) => (
                        <div
                            key={i}
                            className="partner-card bg-[#151515] border border-white/10 p-8 text-left hover:border-phoenix/50 transition-colors group cursor-pointer relative overflow-hidden"
                        >
                            ...
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <Link2 size={16} className="text-white/20 ml-auto group-hover:text-phoenix transition-colors" />
                            </div>
